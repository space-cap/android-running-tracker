...
class RunningRepositoryImpl @Inject constructor(
    ...
    override fun getAllRunsSortedByDate(): Flow<List<RunEntity>> = runningDao.getAllRunsSortedByDate()

    override fun getAllRunsSortedByTimeInMillis(): Flow<List<RunEntity>> = runningDao.getAllRunsSortedByTimeInMillis()

    override fun getAllRunsSortedByCaloriesBurned(): Flow<List<RunEntity>> = runningDao.getAllRunsSortedByCaloriesBurned()

    override fun getAllRunsSortedByAvgSpeed(): Flow<List<RunEntity>> = runningDao.getAllRunsSortedByAvgSpeed()

    override fun getAllRunsSortedByDistance(): Flow<List<RunEntity>> = runningDao.getAllRunsSortedByDistance()
    ...
    override fun getTotalAvgSpeed(): Flow<Long> = runningDao.getTotalAvgSpeed()
}
